...
|---------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|
| `environment`                               |  Additional `key: value` environment variables for atlantis                                                                                                                                      | n/a |
...
| `requireApproval` | Require pull requests to be "Approved" before allowing the apply command to be run. | `false`                    |
